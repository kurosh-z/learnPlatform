...
export class CustomCylinderBufferGeometry extends BufferGeometry {
    ...
    _generateTorso(): void {
        ...
        for (y = 0; y <= heightSegments; y++) {
            ...
            const radius = (1 - v) * (radiusBottom - radiusTop) + radiusTop
        ...
        for (x = 0; x < radialSegments; x++) {
            for (y = 0; y < heightSegments; y++) {
                ...
                const b = this.indexArray[y][x + 1]
                const c = this.indexArray[y + 1][x]
                const d = this.indexArray[y + 1][x + 1]
